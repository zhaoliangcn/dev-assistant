...
const TRANSLATIONS = {
    zh: {
        ...
        model_settings: '模型设置',
        config_file: '配置文件',
        model_settings_hint: '在此配置模型 URL、提供商与 API 密钥，保存后立即生效并写入配置文件。',
        active: '当前',
        ...
        reasoning_effort_hint: '越高思考越深但更慢；留空沿用服务端默认',
        form_required: '请填写名称、提供商、API URL 和模型名',
        save_failed: '保存失败',
        delete_failed: '删除失败',
        delete_model_confirm: '确定删除模型',
        saving: '保存中...',
        // 快捷键
...
performance: 'Performance',
	        ...
	        model_settings_hint: 'Configure model URL, provider and API key here. Changes apply immediately and are saved to the config file.',
	        active: 'Active',
	        ...
	        add_model: 'Add Model',
	        model_name: 'Name',
	        model_name_placeholder: 'Unique name, e.g. primary',
	        provider: 'Provider',
	        api_url: 'API URL',
	        api_key: 'API Key',
	        api_key_keep: 'Leave blank to keep',
	        clear_api_key: 'Clear API Key',
	        temperature: 'Temperature',
	        max_output_tokens: 'Max Output Tokens',
	        reasoning_effort: 'Reasoning Effort',
	        reasoning_effort_hint: 'Higher = deeper thinking but slower; leave empty for server default',
